...
def test_seeds(data_type: str, amount: int, split_num: int, times: int, model_name: str, k: int):
    ...
    for i in range(times):
        ...
        CoMICE_model = CoMICERecommend(item_name, sparse_features, dense_features, seed=i, k=k, backbone=model_name)
...
score, CoMICE_score = test_seeds('AWM', 2000, 1000, 3, 'DCNv2', 5)
print(score)
print(CoMICE_score)